...
//  However, if the parameter is not a valid object with the properties "name" and "age",
//  the function should throw an error with the message "Invalid parameter type". 
// Use try-catch to handle this error and return the error message if it occurs.
